								...
								<div class="pos-order-product">
									...
									<div class="flex-1">
										...
										<div class="d-flex">
											...
											<input type="text" v-model="order.quantity" class="form-control w-50px form-control-sm mx-2 bg-white bg-opacity-25 bg-white bg-opacity-25 text-center" />
							...
							<div v-else class="h-100 d-flex align-items-center justify-content-center text-center p-20">
								<div>
									<div class="mb-3 mt-n5">
										<i class="bi bi-bag text-white text-opacity-50" style="font-size: 6em"></i>
									</div>
							...
							<div class="modal-pos-product">
								...
								<div class="modal-pos-product-info d-flex flex-column">
									...
									<div class="d-flex mb-3">
										...
										<input type="text" class="form-control w-50px fw-bold mx-2 bg-white bg-opacity-25 border-0 text-center" name="qty" v-bind:value="modalQuantity" />
