					...
					<div class="col-xl-9">
						...
						<div id="basicUsage" class="mb-5">
							...
							<p>
								...
								Please read the <a href="https://getbootstrap.com/docs/5.1/components/card/" target="_blank">official Bootstrap documentation</a> for the full list of options.
							</p>
							<card>
								<card-body>
									<div class="row">
						...
						<div id="navigation" class="mb-5">
							...
							<card>
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-3"><b>NAV TABS</b></div>
											<card class="mb-3">
												<card-header>
										...
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-3"><b>NAV PILLS</b></div>
											<card class="mb-3">
												<card-header>
						...
						<div id="images" class="mb-5">
							...
							<card>
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-3"><b>IMAGE CAPS</b></div>
											<card class="mb-3">
										...
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-3"><b>IMAGE OVERLAY</b></div>
											<card class="p-3 mb-3">
						...
						<div id="cardStyles" class="mb-5">
							...
							<card>
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-3"><b>BACKGROUND AND BORDER</b></div>
											<card class="border-theme bg-theme bg-opacity-25 mb-3">
												<card-header class="border-theme fw-bold small text-white">HEADER</card-header>
												<card-body>
													<h5 class="card-title">Primary card title</h5>
													<p class="card-text text-white text-opacity-75">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
												</card-body>
											</card>
										</div>
										<div class="col-xl-6">
											<div class="small text-white text-opacity-50 mb-3"><b>BORDER AND COLOR</b></div>
